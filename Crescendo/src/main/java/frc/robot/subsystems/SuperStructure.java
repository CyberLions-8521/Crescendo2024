...
public class SuperStructure1 extends SubsystemBase {
  ...
  private static SuperStructure1 m_instance = new SuperStructure1();

  public static SuperStructure1 getInstance(){
    return m_instance;
  }
