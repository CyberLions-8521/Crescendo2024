...
public final class Constants {
  ...
  public static class SwerveModuleConstants{
    ...
    public static final double BOTTOM_RIGHT_ENCODER_OFFSET = -0.297363;//-0.3*360;//107.9;//0.444824*360;//0.440918*360;
    public static final double BOTTOM_LEFT_ENCODER_OFFSET = -0.397949 ;//-82;//0.409424*360;//-0.104492 *360;//-0.395508*360;
    public static final double TOP_RIGHT_ENCODER_OFFSET = 0.141846;//-61.17;//-0.341309*360;//-0.359131*360;
    public static final double TOP_LEFT_ENCODER_OFFSET = -0.475098;//10.45;//-0.023438*360;//-0.006836*360;
