...
public class SmartJoint extends SubsystemBase {
  //CONSTRUCTOR
  public SmartJoint() {
    configMotors();
    rezero();
  ...
  private void configMotors(){
    ...
    final int kSmartMotionSlot = 0;
    m_jointControllerLeft.setSmartMotionMaxVelocity(550, kSmartMotionSlot);
    m_jointControllerLeft.setSmartMotionMaxAccel(150, kSmartMotionSlot);
    m_jointControllerLeft.setSmartMotionAllowedClosedLoopError(0.5, kSmartMotionSlot);
