...
public class SwerveModule {
  ...
  public void setState(SwerveModuleState state) {
    ...
    // state.angle.minus(getTurnAngle()).getCos();
  ...
  public double getDrivePosition() {
    // return
    // (m_driveMotor.getPosition().getValueAsDouble()/Constants.SwerveModuleConstants.DRIVE_GEAR_RATIO)
    // * CIRCUMFERENCE;
  ...
  public double getDriveVelocity() {
    // return
    // (m_driveMotor.getVelocity().getValueAsDouble()/Constants.SwerveModuleConstants.DRIVE_GEAR_RATIO)
    // * CIRCUMFERENCE;
